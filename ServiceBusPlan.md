...
**Заметки по реализации:**
- **Что сделано:** Создана страница `ServiceBus.razor` и сопутствующий CSS файл. Реализован интерфейс для отправки и получения сообщений с поддержкой истории и задержек.
- **Отклонения от плана:** Нет.
